                                                      ...
                                                      <div class="question-summary-content actionable">
                                                            <div class="d-flex align-items-center">
                                                                  <h3 class="mt-0 question-summary-title">
                                                                        <a href="single.html">Commodi officia cum quia
                                                            ...
                                                            <div
                                                                  ...
                                                                  <div class="question-summary-author">
                                                                        ...
                                                                        <span class="text-muted">asked
                                                                              <time datetime="2024-05-05">13 minutes
                                                                                    ago</time></span>
                                                                  </div>
                                                            </div>
                                                      ...
                                                      <div class="question-summary-content actionable">
                                                            ...
                                                            <div
                                                                  ...
                                                                  <div class="question-summary-author">
                                                                        ...
                                                                        <span class="text-muted ms-2">asked
                                                                              <time datetime="2024-05-05">13 minutes
                                                                                    ago</time></span>
                                                                  </div>
                                                            </div>
                        ...
                        <div class="modal-content">
                              ...
                              <div class="modal-body">
                                    <form>
                                          <div class="row mb-3">
                                                <div class="col-7">
                                                      <label for="question-title" class="form-label">Question
                                                            title</label>
                                          ...
                                          <div class="mb-3">
                                                <label for="question-body" class="form-label">Explain your
                                                      question</label>
                                                <div class="card">
                                                            ...
                                                            <ul class="nav nav-tabs card-header-tabs">
                                                                  <li class="nav-item">
                                                                        <a class="nav-link active" data-bs-toggle="tab"
                                                                              data-bs-target="#write" type="button"
                                                      ...
                                                      <div class="card-body">
                                                            <div class="tab-content" id="myTabContent">
                                                                  <div class="tab-pane fade show active" id="write"
                                                                        role="tabpanel" aria-labelledby="write-tab"
                                                                        tabindex="0">
                                                                        <textarea rows="7" class="form-control"
                                                                              name="body">hit there</textarea>
                                                                  </div>
                                                                  <div class="tab-pane fade show" id="preview"
                                                                        role="tabpanel" aria-labelledby="preivew-tab"
                                                                        tabindex="0">
