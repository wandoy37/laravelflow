                        ...
                        <div class="col-md-12">
                              <div class="border-bottom pb-3 mb-4">
                                    ...
                                    <div class="d-flex question-meta">
                                          ...
                                          <div class="me-3">
                                                <span class="text-muted">Modified</span> {{ question.created_at.human }}
                                          </div>
                                          <div>
                              ...
                              <div class="question-content post-item">
                                    <div class="vote-col">
                                          <div class="d-flex flex-column align-items-center">
                                                <button title="This post is useful"
                                          ...
                                          <div class="post-col actionable">
                                                <div class="question-body">
                                                      <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                                                            Voluptate, tenetur! Deleniti, dicta qui.
                                                            Debitis quidem ad laborum incidunt itaque nostrum, officiis
                                                            eaque perspiciatis ratione magni
                                                            assumenda rerum fuga ut omnis.</p>
                                                </div>
                                                <div class="d-flex justify-content-end mb-2">
                                                      <div class="author">
                                                            <div class="author-info">
                                                                  <div class="text-muted">Answered Oct 2, 2023 17:22
                                                                  </div>
                                          ...
                                          <div class="post-col actionable">
                                                <div class="question-body">
                                                      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga
                                                            soluta error amet sed, earum
                                                            sapiente, iure, facilis tempore aspernatur quidem odit.
                                                            Minima nulla numquam ad voluptate!
                                                            Laboriosam quisquam necessitatibus error.</p>
                                                      <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quis
                                                            ea, numquam excepturi repellat quas
                                                            commodi, corporis magnam eveniet hic quaerat alias dolor
                                                            sint dolores neque ratione porro maiores
                                                            unde odio.</p>
                                                </div>
                                                <div class="d-flex justify-content-end mb-2">
                                                      <div class="author">
