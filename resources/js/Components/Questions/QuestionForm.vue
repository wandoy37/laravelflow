            ...
            <div class="row mb-3">
                  <div class="col-7">
                        ...
                        <input type="text" class="form-control" :class="{ 'is-invalid': form.errors.title }"
                              v-model="form.title" name="title" id="question-title">
                              ...
                              <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="write" role="tabpanel"
                                          ...
                                          <textarea rows="7" class="form-control"
                                                :class="{ 'is-invalid': form.errors.body }" v-model="form.body"
                                                name="body"></textarea>
                                          <div class="invalid-feedback" v-if="form.errors.body">{{ form.errors.body }}
                                          </div>
                                    </div>
